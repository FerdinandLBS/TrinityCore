...
enum eMyWowGossipSender {
    ...
    MW_GOSSIP_SENDER_WARIII_HERO,
    MW_GOSSIP_SENDER_TRADE,
    MW_GOSSIP_SENDER_SUMMON,
    MW_GOSSIP_SENDER_BOT_MANAGE,
    MW_GOSSIP_SENDER_BOT_ADD,
    MW_GOSSIP_SENDER_BOT_REMOVE,

    MW_GOSSIP_SENDER_CLOSE,
    MW_GOSSIP_SENDER_ACTION_DO_TRANS,
    MW_GOSSIP_SENDER_ACTION_BOT_JOIN,
    MW_GOSSIP_SENDER_ACTION_BOT_REMOVE
};
