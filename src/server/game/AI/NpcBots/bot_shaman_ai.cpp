    ...
    */
    struct shaman_botAI : public bot_ai
    {
        ...
        void CheckBloodlust(uint32 diff)
        {
            ...
            if (!(u && ((u->GetHealth() > me->GetMaxHealth() * 5 && u->GetTarget() == me->GetGUID()) || u->GetTypeId() == TYPEID_PLAYER ||
  ...
  /*Talent*///lvl >= 40 && isElem ? InitSpellMap(ELEMENTAL_MASTERY_1) : RemoveSpell(ELEMENTAL_MASTERY_1);
        ...
        void InitHeals() override
        {
            ...
            if (InitSpell(me, HEALING_WAVE_1))
            {
                ...
                _heals[HEALING_WAVE_1] = me->SpellHealingBonusDone(me, spellInfo, spellInfo->Effects[0].CalcValue(me), HEAL, 0, 0);
            }
            else
            ...
            if (InitSpell(me, LESSER_HEALING_WAVE_1))
            {
                ...
                _heals[LESSER_HEALING_WAVE_1] = me->SpellHealingBonusDone(me, spellInfo, spellInfo->Effects[0].CalcValue(me), HEAL, 0, 0);
            }
            else
            ...
            if (InitSpell(me, RIPTIDE_1))
            {
                ...
                _heals[RIPTIDE_1] = me->SpellHealingBonusDone(me, spellInfo, spellInfo->Effects[0].CalcValue(me), HEAL, 0, 0);
            }
            else
                _heals[RIPTIDE_1] = 0;
            ...
            if (InitSpell(me, CHAIN_HEAL_1))
            {
                ...
                _heals[CHAIN_HEAL_1] = me->SpellHealingBonusDone(me, spellInfo, spellInfo->Effects[0].CalcValue(me), HEAL, 0, 0);
            }
            else
