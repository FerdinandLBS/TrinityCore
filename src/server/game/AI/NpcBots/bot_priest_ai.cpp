    ...
    struct priest_botAI : public bot_ai
    {
        ...
        void InitHeals() override
        {
            ...
            if (InitSpell(me, HEAL))
            {
                ...
                _heals[HEAL] = me->SpellHealingBonusDone(me, spellInfo, spellInfo->Effects[0].CalcValue(me), DamageEffectType(3), 0, 0);
            }
            else
                _heals[HEAL] = 0;
            ...
            if (InitSpell(me, FLASH_HEAL_1))
            {
                ...
                _heals[FLASH_HEAL_1] = me->SpellHealingBonusDone(me, spellInfo, spellInfo->Effects[0].CalcValue(me), DamageEffectType(3), 0, 0);
            }
            else
            ...
            if (InitSpell(me, PENANCE_HEAL_1))
            {
                ...
                _heals[PENANCE_1] = me->SpellHealingBonusDone(me, spellInfo, spellInfo->Effects[0].CalcValue(me), DamageEffectType(3), 0, 0);
            }
            else
                _heals[PENANCE_1] = 0;
            ...
            if (InitSpell(me, DESPERATE_PRAYER_1))
            {
                ...
                _heals[DESPERATE_PRAYER_1] = me->SpellHealingBonusDone(me, spellInfo, spellInfo->Effects[0].CalcValue(me), DamageEffectType(3), 0, 0);
            }
            else
