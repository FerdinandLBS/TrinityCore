     ...
     /*tal*/lvl >= 60 && isRest ? InitSpellMap(WILD_GROWTH_1) : RemoveSpell(WILD_GROWTH_1);
        ...
        void InitHeals() override
        {
            ...
            if (InitSpell(me, NOURISH_1))
            {
                ...
                _heals[NOURISH_1] = me->SpellHealingBonusDone(me, spellInfo, spellInfo->Effects[0].CalcValue(me), HEAL, 0, 0);
            }
            else
                _heals[NOURISH_1] = 0;
            ...
            if (InitSpell(me, REGROWTH_1))
            {
                ...
                _heals[REGROWTH_1] = me->SpellHealingBonusDone(me, spellInfo, spellInfo->Effects[0].CalcValue(me), HEAL, 0, 0);
            }
            else
                _heals[REGROWTH_1] = 0;
            ...
            if (InitSpell(me, HEALING_TOUCH_1))
            {
                ...
                _heals[HEALING_TOUCH_1] = me->SpellHealingBonusDone(me, spellInfo, spellInfo->Effects[0].CalcValue(me), HEAL, 0, 0);
            }
            else
            ...
            if (InitSpell(me, REJUVENATION_1))
            {
                ...
                _heals[REJUVENATION_1] = me->SpellHealingBonusDone(me, spellInfo, spellInfo->Effects[0].CalcValue(me), DOT, 0, 0);
            }
            else
